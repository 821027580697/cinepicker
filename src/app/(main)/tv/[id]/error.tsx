/**
 * TV 시리즈 상세 페이지 에러 핸들링
 *
 * TV 시리즈 데이터를 가져오는 중 에러가 발생하면
...
export default function TVDetailError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error("TV 시리즈 상세 에러:", error);
  }, [error]);
